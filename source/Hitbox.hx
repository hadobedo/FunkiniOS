...
class Hitbox extends FlxSpriteGroup
{
	...
	public function new(?widghtScreen:Float, bindToControls:Bool = true)
	{
		...
		var hitbox_hint:FlxSprite = new FlxSprite(0, 0).loadGraphic('assets/images/custompad/hitbox_hint.png');
	...
	public function createhitbox(X:Float, framestring:String) {
		...
		var frames = FlxAtlasFrames.fromSparrow('assets/images/custompad/hitbox.png', 'assets/images/custompad/hitbox.xml');
